...
export default function PlantSidebar() {
  ...
  return (
    <aside className="h-full w-full bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 flex flex-col overflow-hidden">
      ...
      <div className="mb-6">
        <h2 className="text-slate-900 dark:text-white font-medium tracking-tight text-lg mb-1">
          Matcha Range
        </h2>
        <p className="text-slate-500 dark:text-white/40 text-xs font-mono uppercase tracking-widest">
          Synthesis v1.0
        </p>
      </div>
