                ...
                <div className="space-y-6">
                    <div className="text-center">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-500 mt-2">
                            Solo la cuenta autorizada puede acceder al panel de administración.
                        </p>
                    </div>
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="w-full flex items-center justify-center px-6 py-4 border-2 
                            border-gray-200 dark:border-gray-600 rounded-xl shadow-sm text-base 
                            ...
                            hover:border-gray-300 dark:hover:border-gray-500 group"
                    >
                        {loading ? (
                            <div className="flex items-center">
                    ...
                    <div className="text-center text-xs text-gray-500 dark:text-gray-400 
                        bg-gray-50 dark:bg-gray-800 p-3 rounded-lg border border-gray-200 
                        ...
                        Solo se permite el acceso a la cuenta de administrador autorizada.
                        <br />
                        Todas las sesiones son monitoreadas por seguridad.
                    </div>
                </div>
            </div>
        </div>
