...
export const ProjectsPresentational: FC<Props> = ({
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-purple-900 via-slate-900 to-slate-800">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center mb-2 text-white">{data.title}</h2>
        <p className="text-lg text-slate-300 text-center mb-8">{data.subtitle}</p>
        ...
        {projects?.map((project, idx) => (
            <div
              ...
              className="relative group bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl p-6 flex flex-col hover:scale-[1.025] transition-transform duration-300"
            >
              <img
                src={project.image}
                alt={project.title}
